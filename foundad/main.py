...
from src.train_support import main as app_main_support
from src.AD import main as AD, _demo
from src.AD_support import main as AD_support
...
def process_main(rank: int, cfg_dict: dict, world_size: int):
    ...
    if mode == "train":
        ...
        if params.get("meta", {}).get("support_conditioned", False):
            app_main_support(args=params)
        else:
